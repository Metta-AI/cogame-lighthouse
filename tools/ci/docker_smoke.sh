...
# Substitute: lighthouse, coworld-lighthouse, 4.
#
...
#
# env:
#   SMOKE_IMAGE                image, if not given as $1        (coworld-lighthouse:ci)
#   SMOKE_SLUG                 game slug                        (lighthouse)
#   SMOKE_GAME_BIN             game entrypoint                  (/bin/lighthouse)
#   SMOKE_PLAYER_BIN           player entrypoint                (/bin/lighthouse-player)
...
image="${1:-${SMOKE_IMAGE:-coworld-lighthouse:ci}}"
slug="${SMOKE_SLUG:-lighthouse}"
