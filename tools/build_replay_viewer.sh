...
test -s "${dist}/lighthouse_replay.wasm"
test -s "${dist}/lighthouse_replay.js"

rm -rf "${output_dir}"
mkdir -p "${output_dir}/assets"
cp "${dist}/lighthouse_replay.js" "${dist}/lighthouse_replay.wasm" \
  "${output_dir}/"
...
echo "lighthouse replay viewer bundle: ${output_dir}"
